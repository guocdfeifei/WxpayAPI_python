...
# 一下配置重点参考了 tornado : https://github.com/tornadoweb/tornado/blob/master/docs/conf.py
import os
import sys
...
project = 'WxpayAPI_python'
copyright = '2018, weihaipay'
author = 'https://github.com/weihaipy'
...
latex_documents = [
    (master_doc, 'sphinx.tex', '孚玖 Documentation',
     'xiazhujie', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx', '孚玖 Documentation',
     [author], 1)
]
